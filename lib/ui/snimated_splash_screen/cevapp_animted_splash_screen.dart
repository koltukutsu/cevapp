...
import 'package:cevapp/ui/screens/avatar/avatar_screen.dart';
...
class CevappAnimatedSplashScreen extends StatefulWidget {
  ...
  @override
  State<CevappAnimatedSplashScreen> createState() => _CevappAnimatedSplashScreenState();
}

class _CevappAnimatedSplashScreenState extends State<CevappAnimatedSplashScreen> {
  @override
  void initState() {
